...
class HeadLineEntityAdapter extends TypeAdapter<HeadLineEntity> {
  @override
  final int typeId = 2;

  @override
  HeadLineEntity read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
  ...
  @override
  void write(BinaryWriter writer, HeadLineEntity obj) {
    writer
      ..writeByte(4)
      ..writeByte(1)
      ..write(obj.title)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is HeadLineEntityAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
